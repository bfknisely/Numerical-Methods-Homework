...
fprintf('Numerical 1D UDS function.\n')
...
fprintf('Numerical 1D CDS function.\n')
...
p = loglog(x, erruds, 'b-.', x, errcds, 'r:')
set(p, 'linewidth', 3)
...
%     x phian phiuds phicds erruds errdcs
